...
app.setHandler({
  ...
  EnterDoorIntent() {
    ...
    if (this.$inputs.color.value === 'blue') {
        speech = 'You chose to go through the blue door.There is a dark, long floor. Suddenly, you hear a sound from a room at the end of it. Do you want to follow the sound?';
